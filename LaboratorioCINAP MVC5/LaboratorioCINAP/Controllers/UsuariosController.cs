...
namespace LaboratorioCINAP.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Usuario,ID_TipoUsuario,Nombre,Usuario1,Contrasena,Activo")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Usuario,ID_TipoUsuario,Nombre,Usuario1,Contrasena,Activo")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
